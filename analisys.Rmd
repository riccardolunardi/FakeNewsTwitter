...
ggplot(tweets_with_retweet_number) +
  geom_bar(aes(x = as.Date(created_at)), fill = "#1DA1F2") +
  labs(title = "Quanto frequentemente vengono condivise le notizie?", x="Data del tweet", y="") +
