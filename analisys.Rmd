...
#Sequenza dei giorni di aprile + doppione
june=get_tweets_by_date("2020-06-01",14)
...
```{r}
link_siti_non_affidabili <- "https://raw.githubusercontent.com/riccardolunardi/ProgettoFondamenti/master/websites/websites_fakenews.txt?token=AIZMNOZGHQAVE6HUPP4FYNK65B5ME"
