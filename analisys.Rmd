...
june=june[!june %in% c("data/day2020-06-19.json", "data/day2020-06-24.json")] #Tolgo questo giorno perché è incluso nel file day2020-06-19.json
...
GRAFICO DISCRETO PER PERCENTUALI TWEET/RETWEET, QUAL È LA PERCETUALE
...
#GUARDARE NOTIZIE CON ANCHE RETWEET E PROVARE A SPIEGARE LE NEUTRALITA'


Come ultima analisi, cerchiamo di capire su che argomenti hanno puntato le fake news e se hanno seguito il trend delle notizie più in voga al momento
...
stop_words_extra = c("t.co","https","lkhl0j1pqm","wgyypsdiqo","lkhl0ike2c","tpm3unabk9","amp","2")
...
text_mining_tweets %>%
  ...
  with(wordcloud(word, n, max.words = 120, rot.per = 0, random.order=FALSE, random.color=FALSE, colors=brewer.pal(8, "Dark2")[factor(is_affidabile)]))
